...
func (api *API) endpoints() {
	...
	//api.router.HandleFunc("/posts/{id:[0-9]+}", api.postsHandlerById).Methods(http.MethodGet, http.MethodOptions)
}
...
//func (api *API) postsHandlerById(w http.ResponseWriter, r *http.Request) {
//	var p storage.Post
//	id, _ := strconv.Atoi(mux.Vars(r)["id"])
//	p.ID = id
//	fmt.Print(p)
//	post, err := api.db.PostById(p)
//	if err != nil {
//		http.Error(w, err.Error(), http.StatusInternalServerError)
//		return
//	}
